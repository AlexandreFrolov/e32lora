...
// ==========================================================================
    ...
    export function e32config(addr: NumberFormat.UInt16LE, channel: number, fixedm: boolean, ubaud: UartBaud, airbaud: AirBaud, pwr: number, save: boolean): string {

        let addrString = decToHexString(addr, 16);
